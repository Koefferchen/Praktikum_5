...
def plot_fit_data_Na(exp_data, fit_data, chi, parity, id ):
...
channels_left    = data_left[ : , 0]
counts_left      = data_left[ : , 1]
counts_err_left  = np.sqrt(counts_left)+1
exp_data_Na_left = [channels_left, None, counts_left, counts_err_left ]
...
plot_fit_data_Na( [channels_left, None, counts_left, None], fit_data_Na_left, chi_Na_left, "Links", "2" )
...
channels_right    = data_right[ : , 0]
counts_right      = data_right[ : , 1]
counts_err_right  = np.sqrt(counts_right)+1
exp_data_Na_right  = [channels_right, None, counts_right, counts_err_right ]
...
plot_fit_data_Na( [channels_right, None, counts_right, None], fit_data_Na_right, chi_Na_right, "Rechts", "5" )
...
def plot_fit_data_Ba( exp_data, fit_datas, chis, parity, id ):
...
channels_left    = data[ : , 0]
counts_left      = data[ : , 1]
counts_err_left  = np.sqrt(counts_left)+1

exp_data_Ba_left = [channels_left, None, counts_left, counts_err_left ]
...
plot_fit_data_Ba( [channels_left, None, counts_left, None ], fit_datas_Ba_left, chis_Ba_left, "Links", "3")
...
channels_right    = data[ : , 0]
counts_right      = data[ : , 1]
counts_err_right  = np.sqrt(counts_right)+1

exp_data_Ba_right = [channels_right, None, counts_right, counts_err_right ]
...
plot_fit_data_Ba( [channels_right, None, counts_right, None ], fit_datas_Ba_right, chis_Ba_right, "Rechts", "6")
